...
fizzfest = Event.create({
    ...
    description: "Enjoy an afternoon sampling a variety of hard seltzers 
        from companies across the country while local artists dazzle you 
        with live painting and interactive installations. 
        It's the end-of-summer seltzer event you don't want to miss!",
